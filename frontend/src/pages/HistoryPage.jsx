    ...
    <div className="min-h-screen bg-[#0f0f0f']">
      ...
      <main className="pt-24 px-6 max-w-3xl mx-auto pb-16">
        ...
        <div className="mb-8">
            ...
            <div className="mb-6">
            <label className="block text-sm text-[#8a8480] mb-2">
                Select Account
            </label>
            ...
            <select
                ...
                className="w-full bg-[#151515] border border-[#303030] rounded-lg px-3 py-2 text-sm text-[#f0ede8] outline-none focus:border-[#c8a96e]"
            >
                {accounts.map((acc) => (
